...
C_Timer.After(10, function()        
        ...
        if x ~= "koKR" then -- XXX temp, Options/Locales needs updated
            ...
            if MDR["guide"]<5 then
                print("▶[|cFF33FF99쐐기돌 보고서 "..MDR["version"].."|r]: 이제 |cff8787ED!주차|r로 위대한 금고의 쐐기 보상 정보를 불러올 수 있지만, 현재 SavedInstance 에서 시간을 초과한 기록은 인식하지 못하고 있어 현재 접속중이지 않은 캐릭터의 정보는 부정확할 수 있습니다. (조만간 수정될 예정)")               
